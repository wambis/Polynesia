...
#Define size list
#figname = "Fig_Rapypath_LandStations_in_Chunk.png"
figname = "Fig_Rapypath_LandStations_in_Chunk_dot.png"
#Define a box
...
############## Check ##############################
    ...
    if(stn_id not in INFOS_DICT.keys()):
        ...
        if(it_chk not in CHECK):
            ...
            m.drawgreatcircle(event_lon, event_lat, slon, slat, linewidth=0.4, color='k', alpha = 0.2)
            #plot the sources on the map
