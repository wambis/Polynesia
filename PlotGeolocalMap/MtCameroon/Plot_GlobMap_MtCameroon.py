...
m.drawparallels(range(2, 14, 2), labels=[1, 0, 0, 0], fontsize=10)  # Parallels
m.drawmeridians(range(8, 17, 2), labels=[0, 0, 0, 1], fontsize=10)  # Meridians

# Plot topography
m.etopo(alpha=0.85)

# Save the figure
figname = "Cameroon_Map.png"
plt.savefig(figname, bbox_inches="tight")
plt.close(fig)
